from .antenna_tests import TestAntennaAPIView
from .camera_tests import TestCameraAPIView
from .frame_tests import TestFrameAPIView
from .motor_tests import TestMotorAPIView
