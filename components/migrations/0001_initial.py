...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('min_cells', models.IntegerField(default=1, help_text='In number', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Min. number of cells')),
                ('max_cells', models.IntegerField(default=1, help_text='In number', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Max. number of cells')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spi_support', models.BooleanField(default=True, verbose_name='SPI Support')),
            ],
            options={
                'verbose_name': 'Gyro',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('osd', models.CharField(help_text='OSD Chip Model', max_length=50, verbose_name='OSD Chip')),
                ('bluetooth', models.BooleanField(default=True, help_text='Bluetooth Support')),
                ('wifi', models.BooleanField(default=True, help_text='Wifi Support')),
                ('barometer', models.BooleanField(default=True, help_text='Barometer Support')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.CharField(max_length=50)),
                ('model', models.CharField(help_text='Full name of the item', max_length=50)),
                ('is_wireless_conf', models.BooleanField(default=True, verbose_name='Is Wireless Configuration Available?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='components.frame')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peak_current', models.FloatField(help_text='Peak current of the motor, A', validators=[django.core.validators.MinValueValidator(0)])),
                ('idle_current', models.FloatField(help_text='Idle current of the motor, A', validators=[django.core.validators.MinValueValidator(0)])),
                ('resistance', models.FloatField(help_text='Resistance, in mΩ (mOhm)', validators=[django.core.validators.MinValueValidator(0)], verbose_name='Internal Resistance')),
                ('image', models.FileField(blank=True, null=True, upload_to='motors/tests', verbose_name='Test Results Documentation')),
