            ...
            <div className="p-6 overflow-y-auto flex-1">
                ...
                <div className="components-summary mb-5 border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div className="summary-cards p-2">
                        {Object.entries(droneComponents).map(([key, component]) => {
                            ...
                            return (
                                <div key={key}
                                     className="summary-card flex items-center p-3 border-b border-gray-100 last:border-0">
                                    <div
                                        className={`summary-icon w-10 h-10 rounded-full ${componentTheme.bg} text-white flex items-center justify-center font-semibold mr-3`}>
                ...
                {missingComponents.length > 0 && (
                    <div className="missing-components border border-gray-200 rounded-lg overflow-hidden">
                        <div
                            className="missing-header bg-gray-50 p-3 font-semibold text-primary border-b border-gray-200">
                            Missing Components
                        </div>
                        ...
                        <div className="missing-list p-2">
                            {missingComponents.map(component => {
                                ...
                                return (
                                    <div key={component}
                                         className="missing-item flex items-center p-3 border-b border-gray-100 last:border-0">
                                        <div
                                            className={`missing-icon w-10 h-10 rounded-full ${componentTheme.bg} text-white flex items-center justify-center font-semibold mr-3`}>
                                            <FontAwesomeIcon icon={mapping.icon}/>
                                        </div>
