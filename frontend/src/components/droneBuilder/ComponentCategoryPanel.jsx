...
import {
  faCog, faFan, faMicrochip, faTachometerAlt,
  ...
  return (
    <div className="w-full bg-white rounded-3xl shadow-sm overflow-hidden">
          ...
          <div key={category.title} className="category-group p-4">
            ...
            {category.items.map(item => {
              ...
              return (
                ...
                >
                  <div className={`category-icon w-8 h-8 rounded-full flex items-center justify-center mr-3 text-white ${themeClass.bg}`}>
                    <FontAwesomeIcon icon={item.icon} />
                  </div>
                  <div className="category-label flex-1">{item.label}</div>
                  <div className={`category-status w-5 h-5 rounded-full flex items-center justify-center text-xs ${
                    item.selected 
      ...
      <div className="weight-calculator p-4 border-t border-gray-100">
        ...
        <div className="weight-row weight-total flex justify-between font-semibold border-t border-gray-100 mt-2 pt-2">
