 ...
 * @param {boolean} props.isInList Whether this component is already in a list
 * @param {Function} props.onRemoveFromList Callback when remove from list button is clicked
 */
const ComponentCard = ({
                           item,
                           viewMode = 'list',
